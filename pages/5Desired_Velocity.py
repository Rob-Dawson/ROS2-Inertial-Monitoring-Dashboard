...
SIGNAL_GROUPS = {
    "Desired_Velocity Features": [
        "desired_linear_vel_x","desired_angular_vel_z",
    ],
...
st.title("cmd_vel  Desired Velocity")
...
window_df = window(df, start, end)

st.dataframe(df[["desired_linear_vel_x",
